...
- A scoped Falcon API client on the Commercial CID, read-only recommended.
...
Expect `falcon-commercial` connected, registered under the scoped name `plugin:falcon-commercial-mcp:falcon-commercial`.
